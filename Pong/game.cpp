...
simulate_game(Input* input, float dt) {
	...
	draw_arena_borders(arena_half_size_x, arena_half_size_y, 0x5c5c5c);
	...
	if (current_gamemode == GM_GAMEPLAY) {
		...
		draw_number(player_1_score, -10, 40, 1.f, 0x00ff00);
		draw_number(player_2_score, 10, 40, 1.f, 0x00ff00);

		// Rendering
		draw_rect(ball_p_x, ball_p_y, ball_half_size, ball_half_size, 0x00ff00);

		draw_rect(80, player_1_p, player_half_size_x, player_half_size_y, 0x333333);
		draw_rect(-80, player_2_p, player_half_size_x, player_half_size_y, 0x333333);
		...
		draw_text("PONG", -73, 40, 2, 0xffffff);
		draw_text("MADE BY JANOS RESTYE", -73, 22, .75, 0xffffff);
		draw_text("BY THE TUTORIAL OF DANZAIDAN", -73, 15, .50, 0xffffff);
	}
}